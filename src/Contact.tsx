		...
		<section>
			<div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
				...
				<p className="mb-8 lg:mb-16 font-light text-center text-gray-400 sm:text-xl">
					Want to send some feedback about our protuct? Need details about our Business plan? Let us know.
				</p>
				<form
					action="#"
					className="space-y-8"
				>
					...
					<div className="flex justify-center">
						<button
							type="submit"
							className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-primary-600 hover:bg-primary-700 focus:ring-primary-800 bg-blue-700 hover:bg-blue-800"
						>
							Send message
						</button>
					</div>
